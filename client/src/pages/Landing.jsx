    ...
    >
      <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-white font-bold text-lg tracking-tight">NEXXO</span>
        </div>
        <a
          href="/login"
    ...
    >
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="flex justify-center items-center gap-8 sm:gap-16 mt-12 sm:mt-20"
        >
          {[
            ...
            <div key={i} className="text-center">
              <span className="block text-2xl sm:text-3xl font-bold text-white/90 tracking-tight">
                {stat.value}
              </span>
              <span className="text-[11px] sm:text-xs text-white/35 mt-1 block uppercase tracking-widest">
                {stat.label}
              </span>
            </div>
          ))}
  ...
  return (
    <section className="relative py-24 md:py-36 px-5 bg-landing-dark overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Closing statement */}
        <AnimatedSection delay={0.5} className="mt-14 md:mt-20 max-w-2xl">
          <p className="text-base md:text-lg text-white/60 leading-relaxed border-l-2 border-landing-orange/40 pl-6">
            NEXXO identifica quién tiene influencia real en tu zona y convierte esa influencia
            en clientes para tu negocio.
          </p>
        </AnimatedSection>
      </div>
    </section>
...
function Creators() {
  const benefits = [
    ...
    'Cargás tu perfil, nicho y tarifas',
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <AnimatedSection>
            ...
            <h2 className="text-3xl md:text-[2.8rem] font-black text-white leading-[1.1] mb-6">
              Monetizá tu contenido
              <br />
              <span className="text-white/40">en el Valle de Uco</span>
            </h2>
  ...
  return (
    <footer className="bg-landing-dark border-t border-white/[0.06] py-10">
      <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row justify-between items-center gap-5">
        <div className="flex items-center gap-2.5">
          <img src="/logo_transparent.png" alt="NEXXO" className="h-6 w-auto" />
          <span className="text-white font-bold tracking-tight">NEXXO</span>
        </div>
